...
static const char *fonts[]          = { "CommitMono:size=11" };
...
static const char *colors[][3]      = {
  ...
  [SchemeEmpt] = { col_gray2, col_gray1, col_gray2 },
};
...
/*	{ MODKEY,                       XK_Return, zoom,           {0} },*/
	...
	{ MODKEY|ShiftMask,             XK_comma,  tagtoprev,      {.i = -1 } },
	{ MODKEY|ShiftMask,             XK_period, tagtonext,      {.i = +1 } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
